...
class Machine {
 ...
 public:
  ...
  //Since the machine can only have 1 monster at a time therefore the monster_type and game_level variable is set to static
...
//level up function increase game level, meaning increase the strength of the machine monster in the next battle
  void level_up();
  ...
  //This function used when the machine monster take damage from player and reduce machine health accordingly
  void take_attack(int strength);
  //Set new game level 
  void set_game_level(int _game_level);
  //Display the damage the player take (display the machine monster object strength)
  void display_attack();
